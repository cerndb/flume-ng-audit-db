...
scratch:
	koji build db6 --nowait --scratch  ${REPOURL}${REPOPREFIX}/${REPONAME}.git#origin/build-gateway-kafka-to-hdfs
	koji build db7 --nowait --scratch  ${REPOURL}${REPOPREFIX}/${REPONAME}.git#origin/build-gateway-kafka-to-hdfs

build:
	koji build db6 ${REPOURL}${REPOPREFIX}/${REPONAME}.git#origin/build-gateway-kafka-to-hdfs
	koji build db7 ${REPOURL}${REPOPREFIX}/${REPONAME}.git#origin/build-gateway-kafka-to-hdfs
