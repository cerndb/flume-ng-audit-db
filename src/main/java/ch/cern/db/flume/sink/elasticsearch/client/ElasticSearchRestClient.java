 ...
 * under the License.
 */
package ch.cern.db.flume.sink.elasticsearch.client;
...
import ch.cern.db.flume.sink.elasticsearch.IndexNameBuilder;
...
public class ElasticSearchRestClient implements ElasticSearchClient {
    ...
    /**
    * The username to use for authenticating to ElasticSearch with Shield.
    */
    public static final String USERNAME_PARAM = "username";
    private String username = null;
    
    /**
    * The password to use for authenticating to ElasticSearch with Shield.
    */
	...
	public void configure(Context context) {
		this.username = context.getString(USERNAME_PARAM);
		this.password = context.getString(PASSWORD_PARAM);

		if (username != null && password == null)
			throw new FlumeException("Username for authentication was configured but not the password");
		if (username == null && password != null)
			throw new FlumeException("Password for authentication was configured but not the username");
	}
