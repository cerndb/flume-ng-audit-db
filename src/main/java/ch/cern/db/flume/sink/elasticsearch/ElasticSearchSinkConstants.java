 ...
 * under the License.
 */
package ch.cern.db.flume.sink.elasticsearch;
...
public class ElasticSearchSinkConstants {
  ...
  public static final String DEFAULT_SERIALIZER_CLASS = "ch.cern.db.flume.sink.elasticsearch.ElasticSearchLogStashEventSerializer";
  public static final String DEFAULT_INDEX_NAME_BUILDER_CLASS = "ch.cern.db.flume.sink.elasticsearch.TimeBasedIndexNameBuilder";
}
