...
import ch.cern.db.flume.source.deserializer.AuditEventDeserializer.Builder;
...
public class AuditEventDeserializerBuilderFactory {
	...
	public enum Types {
		TEXT(ch.cern.db.flume.source.deserializer.TextAuditEventDeserializer.Builder.class),
		JSON(ch.cern.db.flume.source.deserializer.JSONAuditEventDeserializer.Builder.class);
